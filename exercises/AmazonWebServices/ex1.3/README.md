...
4. 👉 Review everything, if it all looks good, click the **Create user** orange button to create the new IAM user.
...
## Step 5 - Consuming the Amazon Simple Notification Service Topic in SAP CAP Project.
