        ...
        <VerticalContainer>
            ...
            <View style={{ marginTop: 8 }}>
                <Text style={{ color: "#fff" }}>
                    {
                        "When 'Summarize' is pressed, a summary is generated by GPT-4 based on the CO\u2082 emissions shown in the chart above."
                    }
                </Text>
            </View>
            <CustomModal
                title={"Your CO\u2082 Footprint Summary"}
                titleDescription={`The summaries below were generated by GPT-4 evaluating the CO\u2082 emissions for the categories of the selected months giving recommendations on how to reduce your emissions for the category with the highest ones. Furthermore, the CO\u2082 Footprint gets summarized based on the data of the last ${lastMonths.length} months.`}
                visible={showSummary}
