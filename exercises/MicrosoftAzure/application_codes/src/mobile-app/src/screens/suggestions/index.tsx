...
const Suggestions = () => {
    ...
    const askForComposition = async (
        ...
        askForX(
            ...
            "The following example shows an email generated by GPT-4 to your energy provider asking about the composition of the electricity.",
            query,
    ...
    const askForGreenContract = (
        ...
        askForX(
            ...
            "The following example shows an email generated by GPT-4 to your energy provider requesting a quote for a green power contract.",
            query,
                                ...
                                >
                                    <View style={{ paddingLeft: 0 }}>
                                        {suggestions && suggestions[category.ID] ? (
                                            ...
                                            >
                                                {`If you generate suggestions, GPT-4 will be asked to propose actions for the category ${
