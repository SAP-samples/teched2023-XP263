    ...
    const askForHabitRecommendation = async () => {
        ...
        if (response.ok) {
            ...
            setRecommendation({
                ...
                description: `The following summary is generated by GPT-4 giving recommendations and a step by step guide on how to change your habits to reduce your CO\u2082 emissions`,
