...
const CurrentPeriodSummary = ({ categoryId, style: customStyle = {} }: { categoryId?: string; style?: any }) => {
    ...
    const budget = 409; // 4908 kg yearly / 12 months
    return (
        <EmphasizedSurface>
                    ...
                    {CO2Score <= budget ? (
                        <>
                            ...
                            <Text style={{ color: "#fff" }}>
                                below APJ budget of {budget} kg ({((1 - CO2Score / budget) * 100).toFixed(0)}%)
                            </Text>
                        </>
                    ) : (
                        <>
                            ...
                            <Text style={{ color: "#fff" }}>
                                over APJ budget of {budget} kg ({((CO2Score / budget) * 100).toFixed(0)}
                                %)
                            </Text>
                        </>
                    )}
