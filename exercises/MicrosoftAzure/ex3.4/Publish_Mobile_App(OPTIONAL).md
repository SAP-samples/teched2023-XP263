# Publish Mobile App (OPTIONAL EXERCISE)
...
Continue to - [Exercise 5: Integrate with SAP LLM Services ](../ex3.5/Add_LLM_Access.md) where you will enable Azure Open Ai to interact with the applicaiton
